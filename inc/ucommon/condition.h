 ...
 * @author David Sugar <dyfet@gnutelephony.org>
 */
class __EXPORT ConditionalLock : protected ConditionalAccess, public __VIRTUAL SharedProtocol
{
private:
 ...
 * @author David Sugar <dyfet@gnutelephony.org>
 */
class __EXPORT Semaphore : public __VIRTUAL SharedProtocol, protected Conditional
{
protected:
